...
public class CadastroVoluntarioGUI extends JFrame implements ActionListener {
    ...
    public CadastroVoluntarioGUI() {
        ...
        // Substitua o caminho abaixo pelo caminho correto para a sua imagem
        ...
        titleLabel.setForeground(new Color(0xD3B88C)); // Cor bege
        ...
        subtitleLabel.setForeground(new Color(0xD3B88C)); // Cor bege

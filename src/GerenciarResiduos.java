...
public class GerenciarResiduos extends JFrame {
    ...
    public GerenciarResiduos() {
        ...
        centerPanel.setBounds(50, 200, 700, 400);
        ...
        JButton voltarBotao = createButton("Voltar", 400, 280, 100, 40);

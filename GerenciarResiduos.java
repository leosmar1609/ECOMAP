...
public class GerenciarResiduos extends JFrame {
    ...
    public GerenciarResiduos() {
        ...
        ImageIcon logoIcon = new ImageIcon("C:\\Users\\Ryan\\Downloads\\logo.png"); // caminho da imagem do logo
        ...
        centerPanel.setLayout(null); // Alterado para layout nulo para posicionar manualmente
        centerPanel.setBackground(Color.WHITE);
        add(centerPanel);

        JLabel tipoLabel = new JLabel("Tipo de Resíduo:");
        tipoLabel.setForeground(new Color(0, 102, 51)); // Cor RGB
        tipoLabel.setBounds(50, 30, 150, 30); // Ajustando posição e tamanho
        centerPanel.add(tipoLabel);

        tipoField = new JTextField();
        tipoField.setBounds(200, 30, 300, 30); // Ajustando posição e tamanho
        centerPanel.add(tipoField);

        JLabel categoriaLabel = new JLabel("Categoria:");
        categoriaLabel.setForeground(new Color(0, 102, 51)); // Cor RGB
        categoriaLabel.setBounds(50, 80, 150, 30); // Ajustando posição e tamanho
        centerPanel.add(categoriaLabel);

        categoriaField = new JTextField();
        categoriaField.setBounds(200, 80, 300, 30); // Ajustando posição e tamanho
        centerPanel.add(categoriaField);

        JLabel descricaoLabel = new JLabel("Descrição:");
        descricaoLabel.setForeground(new Color(0, 102, 51)); // Cor RGB
        descricaoLabel.setBounds(50, 130, 150, 30); // Ajustando posição e tamanho
        centerPanel.add(descricaoLabel);

        descricaoField = new JTextField();
        descricaoField.setBounds(200, 130, 300, 30); // Ajustando posição e tamanho
        centerPanel.add(descricaoField);

        JLabel descarteLabel = new JLabel("Descarte:");
        descarteLabel.setForeground(new Color(0, 102, 51)); // Cor RGB
        descarteLabel.setBounds(50, 180, 150, 30); // Ajustando posição e tamanho
        centerPanel.add(descarteLabel);

        descarteField = new JTextField();
        descarteField.setBounds(200, 180, 300, 30); // Ajustando posição e tamanho
        centerPanel.add(descarteField);

        JButton cadastrarBotao = createButton("Cadastrar Resíduo", 250, 230, 200, 40); // Ajustando posição
        ...
        JButton voltarBotao = createButton("Voltar", 470, 230, 100, 40); // Ajustando posição

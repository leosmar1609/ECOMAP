...
public class ColetaResiduos extends JFrame implements ActionListener {
    ...
    public ColetaResiduos(String cpf) {
        ...
        txtDescricao.setBounds(400, 260, 300, 60);
        ...
        JLabel lblBairros = new JLabel("Bairro:");
    ...
    public int getCodPontoColeta(String bairropontocoleta) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == coletarButton) {
            try {
                ...
                String quantidadeColetada = txtQuantidade.getText();
                LocalDateTime datahora_coleta = LocalDateTime.now();

                rastreamento rastreamento = new rastreamento();
                rastreamento.setTiporesiduo(tiporesiduo);
                rastreamento.setCodresiduo(codresiduo);
                rastreamento.setCodvol(codvol);
                rastreamento.setCodpontocoleta(codpontocoleta);
                rastreamento.setQuantcoletada(quantidadeColetada);
                rastreamento.setDatahora_coleta(datahora_coleta);

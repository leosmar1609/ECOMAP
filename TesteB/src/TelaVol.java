...
public class TelaVol extends JFrame {
    ...
    public TelaVol(String cpf) {
        ...
        coletar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                dispose();
                new ColetaResiduos(cpfUsuarioLogado).setVisible(true); // Passa o CPF para a próxima tela
            }
        });
        painel.add(coletar);
        ...
        alterar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                dispose();
                new AlterarDadosUsuario(cpfUsuarioLogado).setVisible(true); // Passa o CPF para a próxima tela
            }
        });
        painel.add(alterar);
    ...
    public static void main(String[] args) {
        new TelaVol("CPF_TESTE"); // Para teste
    }
}
